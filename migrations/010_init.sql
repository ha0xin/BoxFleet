...
VALUES ('network_event_retention_days', '90')
...
DROP TABLE IF EXISTS raw_log_entries;
DROP TABLE IF EXISTS node_heartbeats;
DROP TABLE IF EXISTS traffic_usage_deltas;
DROP TABLE IF EXISTS traffic_reports;
DROP TABLE IF EXISTS node_config_status;
DROP TABLE IF EXISTS config_versions;
DROP TABLE IF EXISTS user_node_bindings;
DROP TABLE IF EXISTS route_profiles;
DROP TABLE IF EXISTS node_outbounds;
DROP VIEW IF EXISTS proxy_access_details;
DROP TABLE IF EXISTS proxy_accesses;
DROP VIEW IF EXISTS proxy_details;
