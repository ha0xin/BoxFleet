...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[10rem] overflow-hidden rounded-md border border-gray-alpha-400 bg-background-100 p-1 text-sm text-gray-1000 shadow-menu",
...
>(({ className, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive && "text-red-800 focus:bg-red-100",
      className
    )}
    {...props}
  />
